...
<body>
    ...
    <div class="container" style="padding-top: 10px;">
        <h3>Update User</h3>
        <hr>
        <form method="post" name="edit" action="<?php echo base_url().'index.php/user/edit/'.$user['user_id'];?>">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                   ...
                   <a href="<?php echo base_url().'index.php/user/index';?>" class="btn btn-danger">CANCEL</a></button>
